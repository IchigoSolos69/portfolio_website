            ...
            <div className="mt-12 relative opacity-0" style={{ animation: 'word-appear 1s ease-out forwards', animationDelay: '4.5s' }}>
              <div className="relative flex items-center justify-center min-h-[200px]">
                ...
                <button 
                  ...
                  className="relative z-50 bg-slate-800 w-[280px] sm:w-[320px] h-[100px] sm:h-[120px] no-underline group cursor-pointer shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 text-white inline-block hover:scale-105 transition-transform duration-300"
                >
                  ...
                  <div className="relative flex justify-center w-full text-center space-x-2 h-full items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10">
                    <span className="text-xl sm:text-2xl md:text-4xl inline-block bg-clip-text text-transparent bg-gradient-to-r from-neutral-300 via-neutral-600 to-neutral-300">
                      Connect
                    </span>
                  </div>
                </button>
